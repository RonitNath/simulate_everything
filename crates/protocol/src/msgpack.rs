    ...
    fn round_trip_snapshot() {
        let snapshot = V3Snapshot {
            ...
            entities: vec![SpectatorEntityInfo {
                ...
                stack_id: None,
                needs: None,
                current_goal: Some("Work".into()),
                current_action: Some("MoveTo".into()),
                action_queue_preview: vec!["MoveTo".into(), "WorkAt".into()],
                decision_reason: Some("duty 0.60".into()),
                attack_phase: None,
                attack_motion: None,
                weapon_angle: None,

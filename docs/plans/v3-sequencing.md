...
Current baseline after the `v3-shared-exec`, `v3-sim-tick`, `v3-rr-runtime`, and `v3-state-surfaces` passes:
...
- roads and deeper economy systems still contain placeholders and module-only landings
